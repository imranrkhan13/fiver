        ...
        <div className='flex justify-center pt-8'>
            {currentTask.options.map(option => <Option onSelect={async () => {
                ...
                try {
                    ...
                    // Dispatch task completion event to trigger payment button
                    const taskCompletedEvent = new Event('taskCompleted');
                    window.dispatchEvent(taskCompletedEvent);
                    console.log("Task completed, payment now available");
                } catch(e) {
                    console.log(e);
                }
                setSubmitting(false);
